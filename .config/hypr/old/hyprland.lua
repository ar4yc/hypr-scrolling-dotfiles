...
hl.animation({ leaf = "windowsMove", enabled = true, speed = 6.2, bezier = "fast" })
...
hl.bind("CTRL + ALT + S", hl.dsp.exec_cmd("~/.config/hypr/scripts/pin.sh"))
hl.bind("CTRL + ALT + A", hl.dsp.exec_cmd("~/.config/hypr/scripts/autoclicker.sh"))
...
-- Move windows on other workspaces
